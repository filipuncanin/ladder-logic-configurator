namespace ladder_diagram_app.Models.Variables.Instances
{
    ...
    /// </summary>
    public class DigitalAnalogInputOutputVariable : Variable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DigitalAnalogInputOutputVariable"/> class with an empty pin name.
        /// </summary>
        public DigitalAnalogInputOutputVariable()
        {
